...
//    }
public Customer(String id, String password, MemberShipStatus status, int total_miles, int miles_ytd, CustomerAddress address, String phoneNumber, PhoneType phoneNumberType) {
    this.id = id;
    this.password = password;
    this.status = status;
    this.total_miles = total_miles;
